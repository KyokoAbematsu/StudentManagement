...
public class StudentConverter {
  ...
  public List<StudentDetail> convertStudentDetails(List<Student> studentList,
    ...
    studentList.forEach(student -> {
      ...
      List<StudentCourse> convertStudentCourseList = studentCoursesList.stream()
          .filter(studentCourse -> String.valueOf(student.getId()).equals(studentCourse.getStudentId()))
          .collect(Collectors.toList());

      detail.setStudentCourses(convertStudentCourseList);
